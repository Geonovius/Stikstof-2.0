...
rem c:\OSGeo4W\bin\ogr2ogr.exe -lco GEOMETRY_NAME=geom -overwrite -f "PostgreSQL" -a_srs EPSG:28992 PG:"dbname=stikstof user=postgres host='localhost' active_schema=top10nl" !importfile! -progress --debug on 1> import.log 2>&1

c:\OSGeo4W\bin\ogr2ogr.exe -lco GEOMETRY_NAME=geom -overwrite -f "PostgreSQL" -a_srs EPSG:28992 PG:"dbname=!db! user=!usr! host=!host! active_schema=top10nl"  !importfile! --debug on

ECHO start het opschonen van de bestaande TOP10 geodata op basis van de grens
timeout /t 10
